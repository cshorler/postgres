...
/*
 * Vector allocators may need different names
 */
#if defined(ALIGNOF_VEC) && defined(VEC_PREFIX)
#define CONCAT(x,y)				x ## y
#define SUBST(x,y)				CONCAT(x,y)

#define AllocSetContextCreate	SUBST(VEC_PREFIX,AllocSetContextCreate)
#define AllocSetAlloc			SUBST(VEC_PREFIX,AllocSetAlloc)
#define AllocSetFree			SUBST(VEC_PREFIX,AllocSetFree)
#define AllocSetRealloc			SUBST(VEC_PREFIX,AllocSetRealloc)
#define AllocSetInit			SUBST(VEC_PREFIX,AllocSetInit)
#define AllocSetReset			SUBST(VEC_PREFIX,AllocSetReset)
#define AllocSetDelete			SUBST(VEC_PREFIX,AllocSetDelete)
#define AllocSetGetChunkSpace	SUBST(VEC_PREFIX,AllocSetGetChunkSpace)
#define AllocSetIsEmpty			SUBST(VEC_PREFIX,AllocSetIsEmpty)
#define AllocSetStats			SUBST(VEC_PREFIX,AllocSetStats)

#define CHUNKALIGN(x)			TYPEALIGN(ALIGNOF_VEC,x)

#else

#define CHUNKALIGN(x)			TYPEALIGN(MAXIMUM_ALIGNOF,x)
...
#define ALLOC_BLOCKHDRSZ	CHUNKALIGN(sizeof(AllocBlockData))
#define ALLOC_CHUNKHDRSZ	CHUNKALIGN(sizeof(AllocChunkData))
...
AllocSetAlloc(MemoryContext context, Size size)
{
	...
	if (size > set->allocChunkLimit)
	{
		...
		chunk = (AllocChunk) (((char *) CHUNKALIGN(block)) + ALLOC_BLOCKHDRSZ);
		chunk->aset = set;
	 ...
	 */
	chunk = (AllocChunk) CHUNKALIGN(block->freeptr);
